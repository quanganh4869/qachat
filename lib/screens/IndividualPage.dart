...
class _IndividualPageState extends State<IndividualPage> {
  ...
  void initState() {
    ...
    // Tắt emoji khi focus vào TextField
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WillPopScope(
        ...
        child: Column(
          children: [
            Expanded(child: ListView()), // TODO: Danh sách tin nhắn
            Row(
              children: [
                Expanded(
                  child: Card(
  ...
  /// Bottom Sheet cho các action như gửi ảnh, file...
  ...
  Widget emojiSelect() {
    return SizedBox(
      ...
      child: EmojiPicker(
        ...
        config: const Config(emojiViewConfig: EmojiViewConfig(emojiSizeMax: 32)),
      ),
    );
  }
}
